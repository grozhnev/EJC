...
public class Announcement {
    ...
    public static void rules(){
        System.out.println("Main rules:\n" +
                ...
                "*       4.3 By random choice our lottery machine will specify the flight speed of each duck in range 10 to 100 m/s\n" +
                "*           4.3.1 The speed will be randomly changed each second by a single bit  '>>' and '<<' operations .\n" +
                ...
                "*   5) If you bet the duck with the longest distance, your bet doubles and you gets the prise in sum of 200 RUB.\n" +
